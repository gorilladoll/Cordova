$(function(){
    ...
    $(".uploadBtnUpload").click(function(){
        navigator.camera.getPicture(function(imageURI){
            ...
            ft.upload(imageURI,"http://172.19.1.70:80/ImageGallery/bin/uploadImage2.php",
            function(r){
                //Success
            ...
            function(error){
                ...
                window.alert("서버 접속 오류가 발생하였습니다.1");
            },options);
        },function(message){
            window.alert("오류가 발생하였습니다.");
        },
    ...
    var loadImages = function(){
        ...
        $.ajax({
            url:"http://172.19.1.70:80/ImageGallery/bin/load2.php",
            data:{},
            dataType:"jsonp",
            success:function(data){
                ...
                if(data.result == "success"){
                    ...
                    for(var i = 0; i < cnt ; i++){
                        ...
                        $("<img />").attr("src","http://172.19.1.70:80/ImageGallery/image/"+imageName).appendTo(target);
                    }
                ...
                window.alert("서버 접속 오류가 발생하였습니다.2");
            }
        });
    };
